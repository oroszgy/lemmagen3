    ...
    public class ExampleList : ISerializable
    {
        ...
        public void AddMultextFile(StreamReader srIn, string sFormat)
        {
            ...
            while ((sLine = srIn.ReadLine()) != null && iError < 50)
            {
                ...
                {
                    Console.WriteLine("  ERROR: Line doesn't confirm to the given format \"" + sFormat + "\"! Line " +
                                      iLine.ToString() + ".");
                    iError++;
                    continue;
                }
            ...
            if (iError == 50)
                Console.WriteLine("  Parsing stopped because of too many (50) errors. Check format specification");
        }
